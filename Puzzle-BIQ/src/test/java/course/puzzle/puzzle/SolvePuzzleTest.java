...
public class SolvePuzzleTest {
    ...
    @Test
    public void testcheckRightToLeftPositive() throws Exception {
    ...
    @Test
    public void testcheckRightToLeftNegative() throws Exception {
        PuzzlePiece piece1 = new PuzzlePiece(1,1,0,0,1);
        PuzzlePiece piece2 = new PuzzlePiece(2,1,0,1,0);
    puzzlePackage.clear();
    puzzlePackage.add(piece1);
    ...
    @Test
    public void testcheckLefttToRightPositive() throws Exception {
    ...
    @Test
    public void testcheckLefttToRightNegative() throws Exception {
        PuzzlePiece piece1 = new PuzzlePiece(1,0,0,1,1);
        PuzzlePiece piece2 = new PuzzlePiece(2,1,0,-1,1);
    puzzlePackage.clear();
    puzzlePackage.add(piece1);
    ...
    @Test
    public void testcheckTopToBottomPositive() throws Exception {
    ...
    @Test
    public void testcheckTopToBottomNegative() throws Exception {
        PuzzlePiece piece1 = new PuzzlePiece(1,0,1,1,1);
        PuzzlePiece piece2 = new PuzzlePiece(2,0,-1,-1,1);
    puzzlePackage.clear();
    puzzlePackage.add(piece1);
    ...
    @Test
    public void testcheckBottomToTopPositive() throws Exception {
        PuzzlePiece piece1 = new PuzzlePiece(1,0,1,1,1);
        PuzzlePiece piece2 = new PuzzlePiece(2,0,-1,-1,-1);
    puzzlePackage.clear();
    puzzlePackage.add(piece1);
    ...
    @Test
    public void testcheckBottomToTopNegative() throws Exception {
        PuzzlePiece piece1 = new PuzzlePiece(1,0,1,1,1);
